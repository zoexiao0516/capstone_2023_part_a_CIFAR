...
if __name__ == "__main__":
    ...
    CHECKPOINT_DIR = OUTPUT_DIR + f'/CIFAR100_models/LR_{LEARNING_RATE}'
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        print(f"Epoch: {epoch + 1}, Train Accuracy: {val_acc:.2f}%", "Average train Loss:", total_loss/len(trainloader), "Time per epoch", end_time-start_time, flush=True)
